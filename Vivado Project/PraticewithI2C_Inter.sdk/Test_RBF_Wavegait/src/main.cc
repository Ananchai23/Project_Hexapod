...
void step_Wave_Gait2(int i)
{
	 if(i==1)
	  ...
	  trigono_alpha_beta_gramma(537,650,470);  // LEG 3  ground 3
	  SetPositions(j+2);
	  trigono_alpha_beta_gramma(493,650,470);  // LEG 4  ground 2
	  SetPositions(j+3);
	  trigono_alpha_beta_gramma(470,650,470);  // LEG 2  ground 1 max font
	  SetPositions(j+1);
	  trigono_alpha_beta_gramma(482,300,180);  // LEG 6  sky 2
	  SetPositions(j+5);
	  trigono_alpha_beta_gramma(560,650,470);  // LEG 5  ground 4 max back
	  SetPositions(j+4);
	  usleep(300000);
	  trigono_alpha_beta_gramma(548,300,180);  // LEG 1  sky 1
	  SetPositions(j);
	  ReadToque (lpdelay1);
	   }
	      ...
	      if(i==2)
	   {
	  trigono_alpha_beta_gramma(482,300,180);
	  SetPositions(j);
	  trigono_alpha_beta_gramma(537,650,470);
	  SetPositions(j+3);
	  trigono_alpha_beta_gramma(493,650,470);
	  SetPositions(j+1);
	  trigono_alpha_beta_gramma(470,650,470);
	  SetPositions(j+5);
	  trigono_alpha_beta_gramma(560,650,470);
	  SetPositions(j+2);
	  usleep(300000);
	  trigono_alpha_beta_gramma(548,300,180);
	  SetPositions(j+4);
	  ReadToque (lpdelay1);
	   }
	  ...
	  trigono_alpha_beta_gramma(493,650,470);
	  SetPositions(j+2);
	  trigono_alpha_beta_gramma(450,635,470);
	  SetPositions(j+3);
	  trigono_alpha_beta_gramma(482,300,180);
	  SetPositions(j+1);
	  trigono_alpha_beta_gramma(560,650,470);
